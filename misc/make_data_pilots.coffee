...
console.log(JSON.stringify($exp.basicCardData().ships))
console.log('"""')
console.log('')

console.log('pilotData_dict = json.loads("""')
console.log(JSON.stringify($exp.basicCardData().pilotsById))
console.log('"""')



for pilot in $exp.basicCardData().ships
