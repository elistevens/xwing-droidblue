...
import droidblue.cards.generics
...
attackIcon2rule_dict = {
    "xwing-miniatures-font-attack-frontback": droidblue.cards.generics.AttackPrimaryAuxBackRule,
    "xwing-miniatures-font-attack-180": droidblue.cards.generics.AttackPrimaryAuxSideRule,
    "xwing-miniatures-font-attack-turret": droidblue.cards.generics.AttackPrimaryTurretRule,
}
translate_dict = {
    'attack': 'atk',
    'agility': 'agi',
...
for ship_str, raw_dict in raw.shipData_dict.iteritems():
    ...
    rule_list = [droidblue.cards.generics.AttackPrimaryArcRule]
    ...
    for action_str in raw_dict['actions']:
        ...
        rule_list.append(getattr(droidblue.cards.generics, rule_str))
